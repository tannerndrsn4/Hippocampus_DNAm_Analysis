...
#SBATCH --output=/home/tander10/sternerlab/Rapamycin/TrimGalore_%A_%a.out ## %A_%a means add "slurmJobID_ArrayID" to the end of the file name
#SBATCH --error=/home/tander10/sternerlab/Rapamycin/TrimGalore_%A_%a.err
...
trim_galore --paired -o /home/tander10/sternerlab/Rapamycin/Trim_Galore --rrbs /home/tander10/sternerlab/Rapamycin/LIB240613LC/${sampleID}*R1*fastq.gz /home/tander10/sternerlab/Rapamycin/LIB240613LC/${sampleID}*R2*fastq.gz
